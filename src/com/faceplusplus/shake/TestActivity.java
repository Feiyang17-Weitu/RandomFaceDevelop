...
public class TestActivity extends Activity {
	...
	private void setResultView() {
		...
		try {
			...
			mResulName
					.setText(getResources().getString(R.string.shake_tip_err));
	...
	public void startResultVisibleAnim() {
		...
		mResultayout.startAnimation(NeedForAnim.getInstance()
				.getResultVisibleAnim(mhHandler));
	}

	/** 摇出的结果隐藏动画 */
	public void startResultGoneAnim() {
		mResultayout.startAnimation(NeedForAnim.getInstance()
				.getResultGoneAnim(mhHandler));
	}
